...
ural_areas = ["Курганскаяобласть", "Свердловскаяобласть", "Тюменскаяобласть", "Челябинскаяобласть", "Ханты-МансийскийАОк", "Ямало-НенецкийАОк"]

EXTRACT_URAL_FILENAME = "input_1_save_ural.json"
OUTPUT_FILENAME = "output_ural_level_4.json"
